...
$(function() {
	var body = document.body, outer = document.createElement('div');
	outer.style.position = 'absolute';
	outer.style.top = '-5px';
	outer.innerHTML = '<div style="position: fixed; top: -10px;"></div>';
	body.appendChild(outer);

	isSupportFixed = outer.firstChild.offsetTop === -10;
